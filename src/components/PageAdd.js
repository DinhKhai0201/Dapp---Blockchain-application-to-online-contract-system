  ...
  render() {
    ...
    return (
      <div className="container imgbg">
		...
		<h5 className="titlename-data fadeInLeft animated" style={{ paddingTop: '10px', paddingBottom: "40px" }}>Add aparment </h5>
        <div className="add-apartment row">
			<div className ='col-md-8'>
					...
					<div className="form-element form-input">
						...
						<small className="form-element-hint">Ex: 145 Tran Cao Van, Thanh Khe,Thanh Khe Dong, Da Nang</small>
					</div>
					<div className='row'>
					...
					<label for="multi" className ='label-add-image'>
						<div className ='body-add-image'>
							<div className ='content-add-image'>
								<span className='icon-add-image'><AddIcon className ="design-icon"/></span>
							</div>
