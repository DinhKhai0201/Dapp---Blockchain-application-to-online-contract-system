...
class Check extends Component {
    ...
    check = async () => {
        ...
        let that = this
        await web3.eth.personal.ecRecover(msg, `${signature}`)
            .then(add => {
                 contracts.events
                    .AddUser(
                        {
    ...
    render() {
        ...
        let fetch =''
        if (data && data !== '') {
            fetch = <div className ="fetchsign row">
                        <div> <p>Account: {data.myaddress}</p> </div>
        ...
        return (
            <div className ="container" style ={{'marginTop':'100px',marginBottom:'100px'}}>
                <div className="content row">
                    <h5 className="titlename-data fadeInLeft animated" style ={{display:'table',margin:'0 auto',paddingTop:'10px',paddingBottom:"40px"}}>Check signature </h5>
